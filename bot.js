...
client.user.setGame(`TeamMC.ga | BroadCaster`,"http://twitch.tv/S-F")
...
if (message.content === '$invite') {
      message.author.send(' تستطيع مناقشة الاونر بخصوص دعوة البوت <@330955365862735886> ').catch(e => console.log(e.stack));
...
client.on('message', message => {
  ...
  .setColor("#9B59B6")
  .addField(" عفواً , نأسف لإزعاجك لكن هذا البوت يخص السيرفر , ولايمكن دعوته :broken_heart:")
